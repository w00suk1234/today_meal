...
class ReportSummaryCard extends StatelessWidget {
  const ReportSummaryCard({required this.summary, required this.targetKcal, super.key});
    ...
    return Card(
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Text('${summary.totalKcal.round()}kcal', style: const TextStyle(fontSize: 30, fontWeight: FontWeight.w800)),
